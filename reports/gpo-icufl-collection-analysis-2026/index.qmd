...
3.  **Is this what these kind of captures 'typically' look like? What have others done with large collections of disk images like this?**
    ...
    - When considering whether to keep a disk image or extract the files, I'd recommend starting with the [Disk Imaging Decision Factors](https://dannng.github.io/disk-imaging-decision-factors.html) from [Digital Archival traNsfer, iNgest, and packagiNg Group (DANNNG!)](https://dannng.github.io/).
