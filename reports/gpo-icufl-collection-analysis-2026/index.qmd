...
- Note that it's slow, and could probably be much faster with multiple database indexed for particular queries.
...
- Completeness collection completeness is as expected, and clarify the terms under which the deposited content has been made available.
- XML issues
